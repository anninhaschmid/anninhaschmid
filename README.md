...
<section class="content-section" aria-labelledby="sobre-mim">
  ...
  <p>
    Sou desenvolvedora pleno com experiência em <strong>desenvolvimento de aplicações web modernas</strong>, com foco em <strong>performance, acessibilidade e usabilidade</strong>. Tenho paixão por construir interfaces elegantes que otimizam a experiência do usuário e resolvem problemas reais de negócios.
  </p>
  <ul>
...
<!--
**anninhaschmid/anninhaschmid** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
